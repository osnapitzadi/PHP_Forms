<?php 
session_start();
include_once 'adil_functions.php';
...
<body>
    ...
    <div class="container">
        ...
        if($_SESSION['counter'] >= 3) {
            ...
            echo '<form action="adil_output.php" method="post">
        ...
        <a class="btn btn-success" href="adil_output.php" role="button">View all records</a>
